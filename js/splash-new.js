              ...
              case 'tab-button-player-count':
                ...
                if (settings.playerCount === 'Whole class') {
                  createModal(
                    ...
                    'Whole Class Mode uses <span class="p--highlight">one device for the entire class,</span> displayed somewhere everyone can see it (such as a smart TV or projector). The teacher leads the game and calls on students to answer.',
                    'Close'
                  );
