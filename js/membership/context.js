...
const els = {
  ...
  changeEmailPasswordField: document.getElementById("dpaam-change-email-password-field"),
  changeEmailPassword: document.getElementById("dpaam-change-email-password"),
  changeEmailStatus: document.getElementById("dpaam-change-email-status"),
  changeEmailSubmit: document.getElementById("dpaam-change-email-submit"),
  ...
  rebateModal: document.getElementById("dpaam-rebate-modal"),
  rebateModalBack: document.getElementById("dpaam-rebate-modal-back"),
  rebateOrderInput: document.getElementById("dpaam-rebate-order-input"),
