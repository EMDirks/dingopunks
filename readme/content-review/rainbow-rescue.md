# Rainbow Rescue — Content Review

Proofread pass on all 4 resource files under `resource/rainbow-rescue/` (cutscene + reading 3rd/4th/5th grade). Flags concrete errors only per the escape-room content review criteria.
