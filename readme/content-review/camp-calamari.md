# Camp Calamari — Content Review

Proofread pass on all 20 resource files under `resource/camp-calamari/` (cutscene, math, reading). Flags concrete errors only per the escape-room content review criteria.
...
| Section | Files reviewed | Files with issues | Issue count |
|---------|----------------|-------------------|-------------|
| Cutscene | 1 | 0 | 0 |
| Math — All Grades | 3 | 2 | 5 |
| Math — Fractions | 3 | 2 | 6 |
| Math — Multiplication | 2 | 2 | 3 |
| Math — Order of Operations | 1 | 1 | 2 |
| Reading — All Grades | 3 | 3 | 10 |
| Reading — Context Clues | 1 | 0 | 0 |
| Reading — Figurative Language | 1 | 0 | 0 |
| Reading — Grammar | 1 | 0 | 0 |
| Reading — Main Idea | 1 | 1 | 1 |
| Reading — Making Inferences | 1 | 0 | 0 |
| Reading — Poetry | 1 | 1 | 2 |
| Reading — Story Elements | 1 | 1 | 1 |
| **Total** | **20** | **13** | **30** |
