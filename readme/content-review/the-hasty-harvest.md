# The Hasty Harvest — Content Review

Proofread pass on all 26 resource files under `resource/the-hasty-harvest/` (`cutscene/cutscene.js` plus every `*Grade.js` under `topic/`). Flags concrete errors only per the escape-room content review criteria. Multiple-choice answer keys were checked against passages where wording or quotes matter.
...
|------|----------------|---------------------|
| Cutscene | 1 | 0 |
| Reading — All Grades | 4 | 2 |
| Reading — Context Clues | 2 | 2 |
| Reading — Figurative Language | 1 | 0 |
| Reading — Grammar | 1 | 1 |
| Reading — Main Idea | 2 | 1 |
| Reading — Making Inferences | 2 | 0 |
| Reading — Poetry | 2 | 1 |
| Reading — Story Elements | 2 | 1 |
| Math — All Grades | 3 | 2 |
| Math — Fractions | 3 | 2 |
| Math — Multiplication | 2 | 0 |
| Math — Order of Operations | 1 | 0 |
| **Total** | **26** | **12** |

Most repeated issues: duplicate "**the the**" in hints/passages (3 files) and subject–verb agreement in word problems and poetry (2 files).
