# The Yeti and the Yams — Content Review

Proofread pass on all 20 resource files under `resource/the-yeti-and-the-yam/` (cutscene, reading, math). Flags concrete errors only per the escape-room content review criteria.
...
Most repeated issues: missing article in Fishbeard's Cell dialogue (3 files) and wrong pronouns for the male Frozen Knight (4 files).
