...
const resource =  {
    ...
    info: {
        ...
        logo: "resource/the-yeti-and-the-yam/assets/branding/reading/all/thumbnail-3rd-grade.png",
    ...
    activityArray: [
        // passages
        {
            ...
            dialogue : {
                ...
                complete: "Did I accidentally turn my hair into a snow cone? Yes. Do I know how to fix it? Nope. Let me know if you have any ideas."
            },
            content: {
                passage: {
                    style: {
                    ...
                    item: [
                        {
                            ...
                            paragraph:  "This lime snow cone is fresh, bold, and super sour! \n\
                                        It has a bright green color you can't miss, and a very strong taste that will really get you going in the morning.\n\
                                        In fact, this snow cone is so sour, it can make your mouth hurt if you eat it too fast.",
                            transform: {
                                translateX: "-10%",
                                translateY: "-3%",
                                rotate: "-1deg",
                        ...
                        },
                        {
                            ...
                            paragraph:  "If you like your dessert to have a gentle flavor, then this pitaya snow cone is perfect for you.\n\
                                        Pitaya (also called dragonfruit) tastes just a little bit sweet, and isn't sour at all.\n\
                                        You definitely won't like this snow cone if you only enjoy strong flavors.\n\
                                        ",
                            transform: {
                                translateX: "0%",
                                translateY: "-20%",
                        ...
                        },
                        {
                            ...
                            paragraph:  "This berry snow cone is a pretty blue color, with an awesome mixture of flavors.\n\
                                        Made with fresh blueberries and gooseberries (which are very hard to get around here), it tastes both sour and sweet.\n\
                                        Eat this snow cone slowly so you can really enjoy it!",
                            transform: {
                                translateX: "-2%",
                                translateY: "-42%",
                                rotate: "-2deg",
                ...
                multipleChoice: [
                    ...
                    },
                    {
                        ...
                        correctIndex: 2,
                        paragraph: [
                            "You won't enj[o]y the pitaya snow cone",
                            "A pita[y]a is also called a dragonfruit",
                            "The pitaya snow con[e] tastes a little bit sweet"
                        ]
                    },
                    {
                        ...
                        paragraph: [
                            ...
                            "It has a p[r]etty blue color",
                            "It is made with blueberr[i]es and gooseberries"
                        ]
                    },
                    {
                        title: "{4.} All three of these passages tell you:",
                        correctIndex: 1,
                        paragraph: [
                            "How to make [s]now cones",
                            "How snow cones tas[t]e",
                            "[W]hy you should not eat snow cones"
                        ]
                    },
                ],
        ...
        // poetry
        {
            ...
            isHintUsed: false,
            dialogue : {
                incomplete: "You need yams? Well, buddy, they don't call me Tater Durant for nothing! Read my poem, and I'll give you as many yams as you need.",
                ...
                poem: {
                    ...
                    item: {
                        ...
                        paragraph: [
                            ...
                            [
                                'Baked or boiled, cut and sliced \u2014',
                                'potatoes taste so good with spice.',
                                'From the ground, they come alive.',
                                'I bet I could eat four or five!'
                            ]
                        ],                
                        transform: {
                            translateX: "0%",
        ...
        // puzzle
        {
            ...
            isHintUsed: false,
            dialogue : {
                incomplete: "Arg! You're lucky I have a whole box of butter on my ship. It's all yours... if you can put together the pieces of my map.",
                complete: "If you're ever looking to join a pirate crew, come find me."
            }, 
            content: {
                puzzle: {
                    style: {
                    ...
                    piece: [
                        ...
                        { text: "The ship was a dancer on the waves.", image: "2.png" },  
                        ...
                        { text: "Courage is a compass through hard times.", image: "6.png" },    
                        { text: "The ship rocked gently like a cradle.", image: "7.png" },                                         
                        { text: "The cave was as dark as a moonless night.", image: "8.png" }, 
                        { text: "The map was as wrinkled as grandpa's face.", image: "9.png" },            
                    ],
                },
                multipleChoice: [
                    {
        ...
        // cryptogram
        {
            ...
            content: {
                    ...
                    passage: [
                        {
                            ...
                            text: {
                                paragraph: "1. The [dazzling] glow of these lightbulbs can light up an entire room."
                            },
                            style: {
                                material: "style-material--metal",
                                paragraph: "style-text--handwritten",
                        ...
                        {
                            text: {
                                paragraph: "3. Keep this water out of [frigid] temperatures, or it might freeze."
                            },
                            style: {
                                material: "style-material--metal",
                                paragraph: "style-text--handwritten",
                        ...
                        {
                            text: {
                                paragraph: "4. These [miniature] screws are so small, you can barely see them."
                            },
                            style: {
                                material: "style-material--metal",
                                paragraph: "style-text--handwritten",
                ...
                decoder: [
                    {
                        title: "{1.} Using context clues, 'dazzling' means:",
                        word: "[B]RIGHT",
                    },
                    {
                    ...
                    {
                        title: "{4.} Using context clues, 'miniature' means:",
                        word: "[T]INY",
                    },
        ...
        // short story
        {
            ...
            dialogue : {
                ...
                complete: "If you escape, send word to the King. We need help!"
            }, 
            content: {
                story: {
                    style: {
                    ...
                    item: {
                        ...
                        paragraph: [
                            ...
                            This yeti stomped on houses, stole crops, and snored way too loudly at night! Of course, she had to be stopped. \n\
                            So, in the middle of the night, I left on a journey to find her.'
                            ,
                            'However, due to my pride, I quickly got lost. \n\
                            The yeti snuck up on me, and threw me into a huge backpack. \n\
                            She carried me deep into this ice cave, dumping me out into a cold, lonely cell. \n\
                            I was surrounded by all sorts of weird creatures, prisoners of the yeti too.'
                            ,
                            'A mad scientist, a lazy musician, a fishy pirate, a creepy little elf... they were all below me. \n\
                            I was a knight, after all! So I kept my distance. \n\
                            But as the days got colder and more lonely, I realized I had no choice. I swallowed my pride and tried to make some friends.'
                            ,
                            'Turns out, they knew all the good survival tricks: finding food, staying warm, and keeping busy. \n\
                            From slippery floors to frozen toes, we faced every challenge together.'
                            ,                            ,
                            'Even though we are still prisoners of the yeti, locked inside this frozen cave, we are a team. \n\
                ...
                multipleChoice: [
                    {
                        title: "{1.} What challenge did the prisoners face?",
                        correctIndex: 2,
                        paragraph: [
                            "Sleepless ni[g]hts",
                            "Chappe[d] lips",
                    ...
                    {
                        title: "{2.} What caused the Frozen Knight to get lost?",
                        correctIndex: 1,
                        paragraph: [
                            "He[r] laziness",
                            "Her [p]ride",
