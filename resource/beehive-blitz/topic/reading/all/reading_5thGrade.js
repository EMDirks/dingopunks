...
const resource =  {
    ...
    info: {
        title: "Beehive Blitz",
        path: "beehive-blitz",
        logo: "resource/beehive-blitz/assets/branding/reading/all/thumbnail-5th-grade.png",
    ...
    activityArray: [
                    ...
                    item: [
                        {
                            image:      "1.png",
                            title:      "Glitterbloom",
                            paragraph:  "You must start collecting Glitterblooms immediately! After all, they're the primary source of our hive's energy. \n\
                                        These extraordinarily important flowers sparkle like glitter, especially in the sunlight. \n\
                        ...
                        },
                        {
                            ...
                            paragraph:  "Ponderbells are quite rare, so collect as many as you can.\n\
                                        ...
                                        That's right, just a few gulps of Ponderbell honey can turn even the most foolish bee into a total genius.",
                            transform: {
                                translateX: "10%",
                                translateY: "-20%",
                                rotate: "3deg",
                        ...
                        },
                        {
                            ...
                            paragraph:  "Beware the Shadowthorn, which grows inside caves. \n\
                                        ...
                                        We cannot harvest such toxic things; I cannot think of a more unsafe act! \n\
        ...
        /* bard's study */
        {
            ...
            isHintUsed: false,
            dialogue : {
                incomplete: "Whoa, you really haven't heard of me? The bee who crafts words as smooth as honey? Surprising, man. Anyway, I wrote a little inspirational poem for the worker bees. If you're curious, check it out.",
                complete: "The storm is definitely coming, my friend... you don\'t want to mess with Gustav."
            }, 
            content: {
                poem: {
                    style: {
                    ...
                    item: {
                        ...
                        paragraph: [
                            [
                                'As storm clouds gather, forewarned by a breeze,',
                                'the bees also gather, with confident ease.',
                                'It\'s nectar they crave, a taste so sweet.',
                                'It\'s vital for the hive, much more than a treat.',
                            ],
                            [
                ...
                crossword: {
                    ...
                    paragraph: [
                        ...
                        'B. How many syllables are in line 3?',
        ...
        /* accounting dept */
        {
            ...
            isHintUsed: false,
            dialogue : {
                incomplete: "The bees put a lot of trust in us leprechauns \u2014 we handle the hive's finances. But I let them all down... I accidentally broke the Queen\'s golden tablet! Can you help me put it back together?",
            ...
            content: {
                puzzle: {
                    ...
                    piece: [
                        ...
                        { text: "These jetpacks will help our bees zoom around.", image: "2.png" },     
                        { text: "These glimmering rings are like golden honey.", image: "3.png" },                     
                        { text: "This honeycomb is the heart of the hive.", image: "4.png" }, 
                        { text: "This huge diamond ring weighs a ton.", image: "5.png" },
                ...
                multipleChoice: [
                    ...
                    {
                        title: "{3.} Rewrite the star piece as a metaphor.",
                        correctIndex: 2,
                        paragraph: [
                            "This [c]oat is extremely soft.",
                            "This coat is as sof[t] as a bee's fuzz.",
                            "This coat is [a] soft, fluffy marshmallow.",
                        ],
                    },
                    {
        ...
        /* the warehouse */
        {
            ...
            content: {
                cryptogram: {
                    ...
                    passage: [
                        {
                            text: {
                                paragraph: "1. This [lambent] gemstone shines brightly in even the darkest room."
                            },
                            style: {
                                material: "style-material--paper",
                                paragraph: "style-text--handwritten",
                        ...
                        {
                            text: {
                                paragraph: "3. Use these [toothsome] spices to add lots of flavor to your honey."
                            },
                            style: {
                                material: "style-material--paper",
                                paragraph: "style-text--handwritten",
                ...
                decoder: [
                    {
                        title: "{1.} Using context clues, 'lambent' means:",
                        word: "G[L]OWING",
                    },
                    {
                    ...
                    {
                        title: "{3.} Using context clues, 'toothsome' means:",
                        word: "T[A]STY",
                    },
                    {
            ...
            dialogue : {
                incomplete: "Name's Grumblegrub, prettiest warehouse manager in the hive. Got a pile of labels here, but I don't like all the fancy words. Turns my brain to mush. I need your eye on this mess, pronto!",
        ...
        /* throne room */
        {
            ...
            isHintUsed: false,
            dialogue : {
                incomplete: "My dear friend, how delightful it is to have you in my throne room! May I kindly suggest you read a history of my leadership? I am certain it will inspire you in these trying times.",
                complete: "My cherished guest \u2014 I hope you enjoyed my story. Please visit again soon."
            }, 
            content: {
                story: {
                    style: {
                    ...
                    item: {
                        ...
                        paragraph: [
                                ...
                                But Bella had considerable dreams. She imagined herself soaring high above the fields of wildflowers, \n\
